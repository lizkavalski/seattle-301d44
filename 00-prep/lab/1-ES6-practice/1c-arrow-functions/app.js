...
// infomation or values of an object Student
// 2. What is "this" when joe.scopeArrow() is invoked?
// It opened up the Windows opject in the computer console log.
// 3. Explain why "this" is different when an arrow function is used.
// I think the reason being "this"  is different when an arrow function is used is it bubbling to the globle window which is seen in line 186. As it said in the README the arrow fuction dose not bind with this so it looks for closeest enclosed scope, if their a lot of arrow function like right now it becomes a globle window.
