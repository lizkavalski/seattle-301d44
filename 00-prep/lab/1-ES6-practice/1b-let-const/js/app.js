...
function displayPics(){
  ...
  // I think the reason in the previous lines it threw an error  because it in a temporal dead zone. The reason being is that in line 33 doesn't have a set definiation to be evaluated yet also according to MDZ it like to be a the top of a code block not hte middle.     
  console.log(viewed);
